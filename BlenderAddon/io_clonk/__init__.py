...
bl_info = {
    "name": "OGRE Clonk Exporter (.scene, .mesh, .skeleton) and RealXtend (.txml)",
    "author": "Brett, S.Rombauts, F00bar, Waruck, Mind Calamity, Mr.Magne, Jonne Nauha, vax456, Richard Plangger, Pavel Rojtberg, Randrian",
    "version": (0, 7, 0),
    "blender": (2, 7, 5),
...
def register():
    logging.info('Starting io_clonk %s', bl_info["version"])
...
def unregister():
    logging.info('Unloading io_clonk %s', bl_info["version"])
